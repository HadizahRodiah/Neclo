...
const Home = () => {
  ...
  const getNews = () => {
    fetch("https://newsapi.org/v2/everything?q=Fashion&sortBy=popularity&apiKey=812d705ef3594e45b3825f3b1e8ae013")
      .then(res => res.json())
      .then(data => {
  ...
  return (
    ...
    <div className='mt-10'>
      {news.map((data, index) => (
        <div key={index} className=" main  max-w-sm rounded bg-whites overflow-hidden shadow-lg m-4" data-aos="fade-up-left">
