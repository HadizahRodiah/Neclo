...
const Asia = () => {
  ...
  const getNews = () => {
    fetch("https://newsapi.org/v2/everything?q=Asia&sortBy=popularity&apiKey=812d705ef3594e45b3825f3b1e8ae013")
      .then(res => res.json())
      .then(data => {
      ...
      <div className="ml-6 flex flex-wrap justify-center">
        <div className='mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
          {currentArticles.map((data, index) => (
            <div key={index} className="main max-w-sm rounded bg-purple-50 overflow-hidden shadow-lg m-4 hover:shadow-2xl transition-shadow duration-300" data-aos="fade-up-left">
